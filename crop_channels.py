...
def split_channels(_image_path, _dst):
    ...
    with rasterio.open("R.tif", 'w', **meta) as out:
        out.write(r)

    with rasterio.open("G.tif", 'w', **meta) as out:
        out.write(g)

    with rasterio.open("B.tif", 'w', **meta) as out:
        out.write(b)
...
if __name__ == '__main__':
    ...
    split_channels(image_path=image_path, folder=dst)
