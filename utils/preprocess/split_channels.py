...
def split_channels(_image_path: Path, _dst: Path):
    ...
    with rasterio.open(_dst / "RED.tif", 'w', **meta) as out:
        out.write(r)

    with rasterio.open(_dst / "GRN.tif", 'w', **meta) as out:
        out.write(g)

    with rasterio.open(_dst / "BLU.tif", 'w', **meta) as out:
        out.write(b)
