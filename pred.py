...
def main(hparam: argparse.Namespace):
    ...
    scores = []
    for i in glob.glob('/home/ari/cases/spltted/*/'):
        input = i[:-1]
        logger.info(input)
        out = os.path.join("/home/ari/cases/pred/",input.split('/')[-1])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='/home/ari/data/ZU/models/zu_1024/3fc640d7_aerial_summer_pieceofland_170522.pth')
